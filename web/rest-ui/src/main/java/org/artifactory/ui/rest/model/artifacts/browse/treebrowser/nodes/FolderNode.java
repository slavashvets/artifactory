...
public class FolderNode extends BaseNode {
    ...
    public void populateActions(AuthorizationService authService) {
        if (isLocal()) {
            ...
            if (isTrash()) {
                ...
                addUploadToBintrayAction(actions);
    ...
    private void addUploadToBintrayAction(List<IAction> actions) {
        if (BintrayRestHelper.isPushToBintrayAllowed() && isDockerManifestFolder()) {
