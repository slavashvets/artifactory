...
export class AdminConfigurationGeneralController {
    ...
    constructor($scope, $q, $timeout, $stateParams, FileUploader, ArtifactoryNotifications, GeneralConfigDao, FooterDao, ArtifactoryEventBus, ArtifactoryModelSaver, ArtifactActionsDao, ArtifactoryModal) {
        this.$scope = $scope;
        this.$q = $q;
