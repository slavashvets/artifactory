        ...
        return [
            {
                ...
                cellTemplate: '<div class="ui-grid-cell-contents">{{row.entity.repoKey.value}}</div>',
            ...
            },
            {
                ...
                cellTemplate: '<div class="ui-grid-cell-contents">{{row.entity.repoType.value}}</div>',
            ...
            {
                field: "percentage",
                cellTemplate: '<div class="ui-grid-cell-contents text-center">{{row.entity.percentageDisplay}}</div>',
                name: "Percentage",
            ...
            },
            {
                ...
                cellTemplate: '<div class="ui-grid-cell-contents">{{row.entity.filesCount.value}}</div>',
                displayName: "Files"
            },
            {
                field: "foldersCount",
                ...
                cellTemplate: '<div class="ui-grid-cell-contents">{{row.entity.foldersCount.value}}</div>',
                displayName: "Folders"
            },
            {
                field: "itemsCount",
                ...
                cellTemplate: '<div class="ui-grid-cell-contents">{{row.entity.itemsCount.value}}</div>',
                displayName: "Items"
            }
