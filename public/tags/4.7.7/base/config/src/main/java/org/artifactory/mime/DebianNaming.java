...
public class DebianNaming {
    ...
    public final static String SOURCES_BZ2 = "Sources.bz2";
    public final static String SOURCES_GZ = "Sources.gz";
    ...
    public static boolean isSourcesIndex(String fileName) {
        return fileName.equalsIgnoreCase(SOURCES_GZ) || fileName.equalsIgnoreCase(SOURCES_BZ2);
    }
