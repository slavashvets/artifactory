...
public class HttpRepo extends RemoteRepoBase<HttpRepoDescriptor> {
    ...
    protected RepoResource handleGetInfoResponse(RepoPath repoPath, HttpRequestBase method, String downloadUrl,
        ...
        try {
            ...
            return new UnfoundRepoResource(repoPath, rre.getMessage(), rre.getRemoteReturnCode());
        }
     ...
     */
    protected void blockMismatchingMimeTypes(@Nullable Request request, CloseableHttpResponse response, String downloadUrl)
            throws RemoteRequestException {
        ...
        if(shouldBlockMimeType(responseContentType, acceptableMimeTypes)) {
            ...
            //TODO [by dan]: remove err log when re-committing fix for virtual 409 (9437)
            log.error(err);
