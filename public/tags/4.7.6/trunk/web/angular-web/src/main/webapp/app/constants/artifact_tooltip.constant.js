...
This description is displayed when the repository is selected in the Tree Browser.`,
                ...
                includesPattern: `List of artifact patterns to include when evaluating
...
By default, all artifacts are included (**/*).`,
                excludedPattern: `List of artifact patterns to exclude when evaluating
...
on central storage, and streaming it directly to satellite pass-though Artifactory servers.`,
...
For example, pseudo jars retrieved behind a "captive portal".`,
                blockMismatchingMimeTypes: `If set, artifacts will fail to download if a mismatch is detected between requested and
