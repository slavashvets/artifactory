...
public class AqlParserTest {
    ...
    public void successParse() throws Exception {
        ...
        assertValid(sm, "archive.entries.find({\"archive.item.artifact.module.build.created\" : {\"$eq\" : \"a.a\"}}).limit(10)");
        assertValid(sm, "items.find({\"created\" : {\"$beforeDays\" : \"5\"}}).limit(10)");
        assertValid(sm, "items.find({\"created\" : {\"$beforeDays\" : 5}}).limit(10)");
        assertValid(sm, "archive.entries.find({\"archive.item.artifact.module.build.created\" : {\"$beforeDays\" : \"10\"}}).limit(10)");
        assertValid(sm, "archive.entries.find({\"archive.item.artifact.module.build.created\" : {\"$beforeYears\" : \"10\"}}).limit(10)");
        assertValid(sm, "archive.entries.find({\"archive.item.artifact.module.build.created\" : {\"$beforeMinutes\" : \"10\"}}).limit(10)");
        assertValid(sm, "archive.entries.find({\"archive.item.artifact.module.build.created\" : {\"$beforeSeconds\" : \"10\"}}).limit(10)");
        assertValid(sm, "archive.entries.find({\"archive.item.artifact.module.build.created\" : {\"$lastDays\" : \"10\"}}).limit(10)");
        assertValid(sm, "archive.entries.find({\"archive.item.artifact.module.build.created\" : {\"$lastYears\" : \"10\"}}).limit(10)");
        assertValid(sm, "archive.entries.find({\"archive.item.artifact.module.build.created\" : {\"$lastMinutes\" : \"10\"}}).limit(10)");
        assertValid(sm, "archive.entries.find({\"archive.item.artifact.module.build.created\" : {\"$lastSeconds\" : \"10\"}}).limit(10)");
    }
    ...
    public void failureOnParse() throws Exception {
        ...
        assertInValid(sm, "archive.entries.find({\"archive.item.artifact.module.build.created\" : {\"$lastSeconds\" : \"10df\"}}).limit(10)");
    }
