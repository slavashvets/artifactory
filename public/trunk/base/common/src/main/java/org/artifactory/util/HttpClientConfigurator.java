...
public class HttpClientConfigurator {
    ...
    public CloseableHttpClient getClient() {
        ...
        if(kerberos) {
            ...
            builder.setDefaultAuthSchemeRegistry(authSchemeRegistry).setDefaultCredentialsProvider(credsProvider).build();
        }
    ...
    /**
     * @param kerberos to activate kerberos executions
     * @return {@link HttpClientConfigurator}
     */
    public HttpClientConfigurator useKerberos(boolean kerberos) {
