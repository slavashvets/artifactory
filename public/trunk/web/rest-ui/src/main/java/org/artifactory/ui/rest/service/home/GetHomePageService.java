...
public class GetHomePageService implements RestService {
    ...
    private void updateAddonList(HashMap<String, AddonInfo> addonInfoMap, List<AddonModel> addonModels) {
        ...
        addonModels.add(new AddonModel(AddonType.BINTRAY_INTEGRATION, getAddonInfo(AddonType.BINTRAY_INTEGRATION, AddonState.ACTIVATED), getAddonLearnMoreUrl("bintrayIntegration"), getAddonConfigureUrl(AddonType.BINTRAY_INTEGRATION.getConfigureUrlSuffix())));
        ...
        //Silent: addonModels.add(new AddonModel(AddonType.HDFS, getAddonInfo(AddonType.HDFS), getAddonLearnMoreUrl("addon-hdfs"), getAddonConfigureUrl(AddonType.HDFS.getConfigureUrlSuffix())));
