...
public interface RepoConfigDefaultValues {
    ...
    boolean DEFAULT_BLOCK_MISMATCHING_MIME_TYPES = true;
    ...
    //CocoaPods
    String DEFAULT_PODS_SPECS_REPO = "https://github.com/CocoaPods/Specs";
    ...
    VcsGitConfiguration DEFAULT_VCS_GIT_CONFIG = new VcsGitConfiguration();
