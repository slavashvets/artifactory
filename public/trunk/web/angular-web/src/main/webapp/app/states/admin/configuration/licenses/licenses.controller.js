    ...
    getCloumns() {
        return [
            ...
            },
            {
                ...
                displayName: "Status",
                field: "status",
                cellTemplate: '<div class="ui-grid-cell-contents"><jf-switch-toggle texton="Approved" textoff="Unapproved" ng-click="grid.appScope.AdminConfigurationLicenses.setStatus(row.entity)" ng-class="{\'on\': row.entity.approved, \'off\': !row.entity.approved}"></jf-switch-toggle></div>',
                width: '15%'
            }
        ]
    }
