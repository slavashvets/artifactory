let snippets = {
    ...
    cocoapods: {
        general: [{
//            before: "In order to use CocoaPods with Artifactory you will need to install the 'cocoapods-art' plugin. To install <a href=\"TODO DANNY link to github or rubygems?\" target=\"_blank\">cocoapods-art</a> run the following command:",
        ...
        read: {
            ...
            snippet: "pod repo-art add <LOCAL_REPO_NAME> \"$2/api/pods/$1\""
        },
        deploy: [{
            ...
            snippet: "pod repo-art push <LOCAL_REPO_NAME> <NAME.podspec>",
    ...
    npm: {
        general: [{
            ...
            snippet: "curl -i -u<USERNAME>:<PASSWORD> $2/api/npm/auth"
        }, {
            ...
            snippet: "curl -i -u<USERNAME>:<PASSWORD> \"$2/api/npm/$1/auth/<SCOPE>\""
        }, {
            before: "The response should be pasted in the <i>~/.npmrc</i> (in Windows %USERPROFILE%/<i>.npmrc</i>) file. Here is an example of the content of the file:",
