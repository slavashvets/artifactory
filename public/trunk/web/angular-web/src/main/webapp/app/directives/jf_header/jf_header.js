...
class jfHeaderController {
    constructor($scope, $q, User, $state, $timeout, $window, GeneralConfigDao, FooterDao, ArtifactoryEventBus, ArtifactoryFeatures, $rootScope, $location, $http, ArtifactoryState) {
        this.$scope = $scope;
